...
c.NotebookApp.notebook_dir = u'%s/' % os.environ['PROJECTS']
...
# Running on Windows
if "WINDOWS" in uname.system.upper():
    browser = "start chrome --app=%s"

# Running on WSL
elif "MICROSOFT" in uname.release.upper():
    token=secrets.token_urlsafe()
    c.NotebookApp.token = token
    browser = "cmd.exe /c start chrome --app='http://localhost:8888/?token=%s&dumb=%s'" % (token, "%s")

# Running on Linux
elif "LINUX" in uname.system.upper():
    browser = "google-chrome-stable --app=%s"

c.LabApp.browser = browser

## The app directory to launch JupyterLab from.
#c.LabApp.app_dir = '/home/djonathan/.asdf/installs/python/miniconda-3.18.3/envs/jupyter/share/jupyter/lab'
...
#c.LabApp.user_settings_dir = u'/home/djonathan/.jupyter/lab/user-settings'

## Whether to serve the app in watch mode
#c.LabApp.watch = False

## The directory for workspaces
#c.LabApp.workspaces_dir = u'/home/djonathan/.jupyter/lab/workspaces'
...
#c.Session.username = u'djonathan'
